...
/*   Updated: 2024/03/21 16:29:50 by alberrod         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	 parse_input("   <\"       'hola $USER son las `datetime`\" 2>> (somewhere) << eof '$PATH | /dev/null' | cat -e");
	...
	cmd_list = parse_input("< in ls -la | echo \"hola mundo\" | wc -c | echo \"This is the $PATH and this is additional $ENV\" | cat -e >>outfile");
